...
![Создание исполняемого файла и его запуск.](image/ris7.jpg){#fig:ris7.jpg width=0.7\textwidth}
...
Теперь вывелось число 106. В этом случае команда add складывает коды символов '6' и '4'. Однако, в отличие от первой проограммы, функция iprintLF позволяет вывести число, а не символ, кодом которого является число.
